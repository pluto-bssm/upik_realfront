      ...
      <div>
        <div className="bg-[#FAFAFA] w-[120vh] h-[60vh] rounded-[2vh]">
            <div className="relative top-[4vh] left-[5vh]">
                <p className="text-[#0158DE] font-['P_Regular'] text-[2vh]">{category}</p>
                <div className="absolute top-[3vh]">
                <p className="text-[#FFFFF] font-['P_Regular'] text-[3vh]">{title}</p>
                    <div className="absolute top-[4vh]">
                        <p className="text-[#A6A6A6] font-['P_Regular'] text-[1.5vh]">{date}   투표마감</p>
                    </div>
                </div>
            </div>
        </div>

        <div className="absolute top-[45%] left-[5vh] h-[auto]">
        <Votemenu/>
        </div>
      </div>
    );
